    ...
    <div>
      <div className="shadow-lg p-4 rounded-lg max-w-xs m-auto border">
        ...
        <div className="mb-2">
          ...
          <input className=" rounded-sm focus-visible:outline-none w-full border px-2 h-8" type="text" placeholder="請輸入手機號碼" />
        </div>
        <hr className=" my-5" />
        <h5 className="mb-4 text-center font-bold">註冊帳號</h5>
        <div className="mb-2">
          <p className="text-sm text-gray-600 mb-1">帳號</p>
          <input className=" rounded-sm focus-visible:outline-none w-full border px-2 h-8" type="text" placeholder="請輸入Email" />
        </div>
        <div className="mb-2">
